  ...
  return (
    <div className="mt-6 flex flex-wrap gap-3">
      ...
      <motion.button
        ...
        className="px-6 py-3 rounded-2xl border border-brand bg-brand text-black font-medium shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-brand focus:ring-offset-2 transition-all"
      >
        Add to Cart
      </motion.button>
