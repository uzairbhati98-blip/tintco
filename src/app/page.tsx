          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fadeInUp">
              ...
              <div className="mt-8 flex flex-wrap gap-4 animate-fadeInUp animation-delay-200">
                <Link 
                  className="inline-flex rounded-2xl bg-brand border-2 hover:bg-brand/90 text-black px-8 py-3.5 font-semibold shadow-soft transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 active:scale-95" 
                  href="/categories"
                >
                  Shop Now
                </Link>
